...
import necroDolls from 'config/abi/necrodolls.json';
import bids from 'config/abi/bid.json';
...
export const useBids = () =>{
  const abi= (bids as unknown) as AbiItem
  return useContract(abi, getBidsAddress())
}

export const useNecroDolls = () =>{
  const abi= (necroDolls as unknown) as AbiItem
  return useContract(abi, getNecroDollsAddress())
}
